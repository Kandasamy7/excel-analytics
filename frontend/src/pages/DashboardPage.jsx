    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 p-6 sm:p-10">
      <div className="max-w-screen-lg mx-auto space-y-6">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-700">Role: <span className="font-semibold text-black">{userData.role}</span></p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white p-6 rounded-2xl shadow border border-blue-200">
            ...
            <p className="text-gray-700">
              You’ve uploaded <strong className="text-blue-900">{uploadStats.length}</strong> file(s).
            </p>
          </div>
